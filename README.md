...
The `/metrics` endpoint exports Prometheus text format metrics, including:

- capstone_prediction_requests_total
- capstone_prediction_errors_total
- capstone_prediction_latency_seconds_sum
- capstone_prediction_latency_seconds_count
- capstone_prediction_latency_seconds_avg
- capstone_prediction_latency_seconds_last
- capstone_prediction_latency_seconds_min
- capstone_prediction_latency_seconds_max
